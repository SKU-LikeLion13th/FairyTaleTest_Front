...
const Start = () => {
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center bg-[#D9F3FE]">
      <p
      ...
      <div className="w-full flex flex-col justify-center items-center text-center">
        ...
        <div>
          ...
          <div className="flex flex-col gap-5 Regular text-[15px]">
            <button className="bg-[#0073FF] p-3 mx-5 rounded-2xl text-white">시작하기 →</button>
            <button className="bg-[#272727] p-3 mx-5 rounded-2xl text-white">제작자 →</button>
          </div>
        </div>
      </div>
    </div>
